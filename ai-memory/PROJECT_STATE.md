...
<!-- AUTO_STATUS:START -->
Generated: 2026-05-05 05:11:44 +0000
...
- Branch: `main`
- HEAD: `be82701`
- Last commit: `be82701 fix(poekhali): simplify live target HUD`
...
* main                                          be82701 [origin/main] fix(poekhali): simplify live target HUD
```
