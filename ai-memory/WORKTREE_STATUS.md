...
* main                                          536f101 [origin/main] fix(poekhali): show profile by travel direction
```

## HEAD
```text
536f101 fix(poekhali): show profile by travel direction
 ai-memory/CHANGELOG.md           |  8 ++++++++
 ai-memory/sessions/2026-05-04.md |  1 +
 scripts/app-constants.js         |  2 +-
 scripts/poekhali-tracker.js      | 16 +++++++---------
 sw.js                            |  2 +-
