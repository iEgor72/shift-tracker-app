...
## 2026-05-06 00:12:09 +0000

- Source: `manual`
- Task: Убрал дубль техтекста в карточке смены
- Branch: `main`
- Methods: `в верхней hero-карточке деталей смены больше не выводится shift technical line под датой`, `подробности состава/поезда остаются ниже в деталях`, `cache bump v294`
- Files: `scripts/time-utils.js`, `scripts/app-constants.js`, `sw.js`

## 2026-05-06 00:14:39 +0000

- Source: `manual`
- Task: Убрал оставшийся серый маршрут под датой
- Branch: `main`
- Methods: `из верхней hero-карточки деталей смены удалён directionHtml`, `теперь под датой не остаётся серый дубль маршрута/поезда`, `подробности остаются ниже в карточках деталей`, `cache bump v295`
- Files: `scripts/time-utils.js`, `scripts/app-constants.js`, `sw.js`

## 2026-05-06 00:16:59 +0000

- Source: `manual`
- Task: Изменил серый текст в календарном окне дня
- Branch: `main`
- Methods: `в renderHomeCalendarDaySheet заменён дублирующий summary под датой на нейтральную подсказку`, `cache bump v296`
